-- Spartan 1 Dashboard Schema (FIXED)
...
-- Function to auto-update days_on_market and days_since_update
CREATE OR REPLACE FUNCTION update_listing_days()
RETURNS TRIGGER AS $$
BEGIN
    -- Calculate days on market
    NEW.days_on_market := EXTRACT(DAY FROM (CURRENT_DATE - NEW.list_date))::INTEGER;
...
-- Trigger to auto-calculate listing days
